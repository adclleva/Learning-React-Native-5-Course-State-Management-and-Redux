...
const styles = StyleSheet.create({
  gridItem: {
    ...
    height: 150,
    borderRadius: 10,
    overflow: "hidden", // this will make sure that child items won't render outside this component
  },
  container: {
    flex: 1,
    borderRadius: 10,
    ...
    shadowRadius: 10,
    elevation: 3, // this is for android, bc the shadow properties only affect ios
    padding: 15,
